...
\let\clearpage\relax 
\relax \pagenumbering{arabic}\setcounter{page}{1}
...
The key application and motivation of this thesis lies, as the name may suggest, in brain dynamics. Several studies
...
Simulation v. Bifurcations (maybe write later)
