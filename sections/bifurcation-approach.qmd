...
In @Verheyden2005, Verheyden and Lust proposed a method of condensation of parameters for ([-@eq-linearized-dde-periodic-orbit-bvp]), such that it is reduced to the following form
$$
\mtr{
	\vi \Gamma(1) - \ident & \cdot \\
	\cdot & \cdot
