...
<!-- TODO: Current implementation is a big plus (reviewed and all) really these 2 toolboxes - I explain how they work -->
...
<!-- TODO: Run dde-biftool and matcont scripts to get time estimate -->
<!-- TODO: Mention we do not need to care about threading order, as the individual slices \lmbd_i are not codependent -->
<!-- TODO: Mention DDEBifurcationKit.jl -->
...
Comparison of heatmaps of phase shifts $\beta$ computed using the simulation-based approach, see @sec-simulation-approach and @fig-metacentrum-shift, and borders of Arnold tongues obtained from the continuation of the cycle manifold $M$, see above.
:::