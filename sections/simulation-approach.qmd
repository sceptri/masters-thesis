...
For illustration purposes, we ran the script generating @fig-checked-shift for 1200-by-1200 grid instead of 75-by-75, see TODO. As we have said, on a regular consumer-grade laptop, such computation would take about 750 minutes. On MetaCentrum, we reserved 20 CPU cores, 36 GiB of RAM and 150 GiB scratch storage with maximal runtime of 16 hours. Using this setup, the computation took TODO.
