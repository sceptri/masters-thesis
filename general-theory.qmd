...
$$
\obj M = \set{\vi \psi \in \contStateSpace \cap \contf{[-\tau, 0], \R^n}{1} : \dvi \psi(0) = \vi f(\sigma, \vi \psi)}.
$$
...
### Time Monoids and Dynamical Systems
