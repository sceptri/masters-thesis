...
In other words, if the coefficients of the 4-stage ERK method comply with conditions ([-@eq-runge-kutta-order-condition-4-stage]), the method is of fourth order, i.e. $\locTrErr_i = O(\diff_i^5)$. Typically, *"the Runge-Kutta"* method is used:
$$
\left.\begin{aligned}
